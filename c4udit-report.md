...
| ---------------- | ----- | ----- |
| G001 **Works Well (no false positives)** | Don't Initialize Variables with Default Value | 22 |
...
| G006 | Use immutable for OpenZeppelin AccessControl's Roles Declarations | 2 |
| G008 | Use Shift Right/Left instead of Division/Multiplication if possible | 3 |
| G009 | ++i costs less gas than i++, especially when its used in for-loops (--i/i-- too) | 34 |
| G010 **Works Well (no false positives)** | USE CUSTOM ERRORS RATHER THAN REVERT()/REQUIRE() STRINGS TO SAVE GAS | 48 |
| G011 | Address 0 check can be done in assembly to save gas | 61 |
| G014 | Setting the constructor to payable | 27 |
| G016 | Assigning keccak operations to constant variables results in extra gas costs | 23 |
| G017 **Works Well (no false positives)** | x += y costs more gas than x = x + y for state variables | 28 |
| G019 | ++i/i++ should be unchecked{++i}/unchecked{i++} when it is not possible for them to overflow | 34 |
| L001 | Unsafe ERC20 Operation(s) | 6 |
| L003 | Unspecific Compiler Version Pragma | 67 |
| L009 | Use of bytes.concat() instead of abi.encodePacked() | 26 |

## Findings

____________________________________________________________________________________________
### **[G001 **Works Well (no false positives)**] Don't Initialize Variables with Default Value**
____________________________________________________________________________________________
...
### **[G009] ++i costs less gas than i++, especially when its used in for-loops (--i/i-- too)**
___________________________________________________________________________________________
...
| party-contracts-c4/contracts/gatekeepers/AllowListGateKeeper.sol | 33 | uint96 id_ = ++_lastId; | [View Code](https://github.com/PartyDAO/party-contracts-c4/blob/main/contracts/gatekeepers/AllowListGateKeeper.sol#L33) |
| party-contracts-c4/contracts/gatekeepers/TokenGateKeeper.sol | 48 | uint96 id_ = ++_lastId; | [View Code](https://github.com/PartyDAO/party-contracts-c4/blob/main/contracts/gatekeepers/TokenGateKeeper.sol#L48) |
| party-contracts-c4/contracts/party/PartyGovernance.sol | 306 | for (uint256 i=0; i < opts.hosts.length; ++i) { | [View Code](https://github.com/PartyDAO/party-contracts-c4/blob/main/contracts/party/PartyGovernance.sol#L306) |
...
### **[G010 **Works Well (no false positives)**] USE CUSTOM ERRORS RATHER THAN REVERT()/REQUIRE() STRINGS TO SAVE GAS**
___________________________________________________________________________________________________________________
...
### **[G011] Address 0 check can be done in assembly to save gas**
______________________________________________________________
...
| party-contracts-c4/contracts/crowdfund/Crowdfund.sol | 367 | if (splitRecipient_ == address(0)) { | [View Code](https://github.com/PartyDAO/party-contracts-c4/blob/main/contracts/crowdfund/Crowdfund.sol#L367) |
...
### **[G014] Setting the constructor to payable**
_____________________________________________
...
| party-contracts-c4/contracts/globals/Globals.sol | 23 | constructor(address multiSig_) { | [View Code](https://github.com/PartyDAO/party-contracts-c4/blob/main/contracts/globals/Globals.sol#L23) |
...
### **[G016] Assigning keccak operations to constant variables results in extra gas costs**
_______________________________________________________________________________________
...
### **[G017 **Works Well (no false positives)**] x += y costs more gas than x = x + y for state variables**
_______________________________________________________________________________________________________
...
| party-contracts-c4/contracts/crowdfund/Crowdfund.sol | 374 | votingPower += (splitBps_ * totalEthUsed + (1e4 - 1)) / 1e4; // round up | [View Code](https://github.com/PartyDAO/party-contracts-c4/blob/main/contracts/crowdfund/Crowdfund.sol#L374) |
...
_______________________________________________________________________________________________________
### **[G019] ++i/i++ should be unchecked{++i}/unchecked{i++} when it is not possible for them to overflow**
_______________________________________________________________________________________________________
...
| File | Line Number | Line Content | Code Location |
| ---- | ----------- | ------------ | ------------- |
| party-contracts-c4/contracts/crowdfund/Crowdfund.sol | 301 | preciousTokens[i].transferFrom(address(this), address(party_), preciousTokenIds[i]); | [View Code](https://github.com/PartyDAO/party-contracts-c4/blob/main/contracts/crowdfund/Crowdfund.sol#L301) |
...
______________________________________________________________
### **[L009] Use of bytes.concat() instead of abi.encodePacked()**
______________________________________________________________
